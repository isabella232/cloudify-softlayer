...
imcloud_client node[:console][:download_name]
...
template ::File.join(bswc_config, 'dswebserver.properties')
...
#log "Install dependencies for r installation"
#
#yum_package "texinfo-tex"
#
