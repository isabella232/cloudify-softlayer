...
default[:db2][:create_os_users]     = "NO"
...
default[:db2][:instance][:home_dir] = ::File.join(node[:db2][:home_path], default[:db2][:instance][:username])
...
default[:db2][:das][:home_dir]      = ::File.join(node[:db2][:home_path], default[:db2][:das][:username])
default[:db2][:das][:uid]           = ""
...
default[:db2][:fenced][:home_dir]   = ::File.join(node[:db2][:home_path], default[:db2][:fenced][:username])
...
if node[:kernel][:machine] == 'x86_64'
  default[:db2][:dsdriver][:arch] = "linuxamd64"
else
  default[:db2][:dsdriver][:arch] = "linuxia32"
end

default[:db2][:dsdriver][:install_path]  = "/opt/ibm"
default[:db2][:dsdriver][:download_name] = "DB2 DSDriver 10.5 FP1 (#{default[:db2][:dsdriver][:arch]})"
